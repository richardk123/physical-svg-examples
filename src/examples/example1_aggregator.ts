...
export class Example1Aggregator implements Example
{
    get htmlCode(): string
    {
        return '<svg id="example1_collision_aggregator" width="100%" height="400px" xmlns="http://www.w3.org/2000/svg" strokeWidth="5px">\n' +
